...
export PATH=$PATH:/usr/local/go/bin:/usr/local/android-studio/bin:$HOME/jdk-17.0.12/bin:/opt/nvim/bin
...
alias luamake="/home/daniel/code/lua-language-server/3rd/luamake/luamake"
